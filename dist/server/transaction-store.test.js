...
describe("Transaction Store", async () => {
    describe("get", async () => {
        it("should use the state to return the decrypted cookie", async () => {
            ...
            expect((await transactionStore.get(requestCookies, state))?.payload).toEqual(transactionState);
        });
    ...
    describe("save", async () => {
        it("should set the cookie on the response", async () => {
            ...
            expect((await decrypt(cookie.value, secret)).payload).toEqual(transactionState);
        ...
        it("should throw an error if the transaction does not contain a state", async () => {
            ...
            await expect(() => transactionStore.save(responseCookies, transactionState)).rejects.toThrowError();
        });
    ...
    describe("delete", async () => {
        ...
        it("should not throw an error if the cookie does not exist", async () => {
            ...
            await expect(transactionStore.delete(responseCookies, "non-existent-state")).resolves.not.toThrow();
        });
    });
});
